...
population_model = function(train, val, imbalance = "NA", sm_train_size, sm_val_size){
  ...
  result = list(summary_result, models)
}
```
...
summary_down1000 = population_model(train, val, imbalance = "down", sm_train_size, sm_val_size )
summary_down1000_result = summary_down1000[[1]]
down1000_models =  summary_down1000[[2]]
```
